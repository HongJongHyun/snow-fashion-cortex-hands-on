-- ============================================================
-- EDU_SALES_SV Step 2: 한국어 Description 추가
-- 
-- Step 1(Fact/Dimension 수정)에 이어서, 주요 컬럼에 한국어 Description을 추가합니다.
-- 비즈니스 맥락과 허용값을 명시하여 LLM의 SQL 생성 정확도를 높입니다.
--
-- 변경 내용:
--   1) Fact/Dimension 수정 (Step 1과 동일하게 유지)
--   2) 전체 컬럼 Description을 한국어로 변경 + 허용값 목록 추가
--
-- 참고: 이 파일은 CREATE OR ALTER로 전체 정의를 다시 작성하므로,
--       EDU_SALES_SV_01_Fact수정.sql의 Fact/Dimension 변경 내용이
--       이미 포함되어 있습니다. 이 파일만 실행해도 Step 1+2가 모두 적용됩니다.
-- ============================================================
